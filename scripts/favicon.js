...
const configuration = (variant) => ({
  ...
  appName: 'Vitus Labs', // Your application's name. `string`
  // appShortName: null, // Your application's short_name. `string`. Optional. If not set, appName will be used
  appDescription: 'Build apps like a PRO', // Your application's description. `string`
  developerName: 'Vit Bokisch <vit@bokisch.cz>', // Your (or your developer's) name. `string`
  developerURL: 'https://vitus-labs.com', // Your (or your developer's) URL. `string`
