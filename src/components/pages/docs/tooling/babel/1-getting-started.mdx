---
name: Babel / Getting Started
---

# Babel

A predefined [Babel](https://babeljs.io/) configuration to build your libraries.
...
# with yarn
yarn add @vitus-labs/tools-babel

# or with npm
npm install @vitus-labs/tools-babel --save
```
